using System.Text;
using YWML.Src.Utils.Tinifan.ArchiveL5.Level5.Compression.NoCompression;
using YWML.Src.Utils.Tinifan.ArchiveL5.Level5.Compression;
        ...
        public void Save(string fileName, ProgressBar progressBar)
        {
            using (FileStream stream = new FileStream(fileName, FileMode.Create, FileAccess.Write))
            {
                ...
                foreach (var folder in folders)
                {
                    ...
                    directoryEntry.Crc32 = BitConverter.ToUInt32(new Crc32().ComputeHash(Encoding.UTF8.GetBytes(directoryName)).Reverse().ToArray(), 0);
                ...
                writer.Write(CompressBlockTo(directoryHashes.ToArray(), new NoCompression()));
                writer.WriteAlignment(4);
